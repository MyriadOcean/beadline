...
class Translations with BaseTranslations<AppLocale, Translations> {
	...
	late final TranslationsQueueEn queue = TranslationsQueueEn.internal(_root);
	...
	late final TranslationsSongEditorEn songEditor = TranslationsSongEditorEn.internal(_root);
	late final TranslationsSettingsEn settings = TranslationsSettingsEn.internal(_root);
	late final TranslationsLibraryLocationsEn libraryLocations = TranslationsLibraryLocationsEn.internal(_root);
	late final TranslationsLocationSetupEn locationSetup = TranslationsLocationSetupEn.internal(_root);
	late final TranslationsConfigModeEn configMode = TranslationsConfigModeEn.internal(_root);
	late final TranslationsOnlineProvidersEn onlineProviders = TranslationsOnlineProvidersEn.internal(_root);
	late final TranslationsDisplayEn display = TranslationsDisplayEn.internal(_root);
	late final TranslationsLyricsEn lyrics = TranslationsLyricsEn.internal(_root);
	late final TranslationsFloatingLyricsEn floatingLyrics = TranslationsFloatingLyricsEn.internal(_root);
	late final TranslationsSongPickerEn songPicker = TranslationsSongPickerEn.internal(_root);
	late final TranslationsVideoRemovalEn videoRemoval = TranslationsVideoRemovalEn.internal(_root);
	late final TranslationsDebugEn debug = TranslationsDebugEn.internal(_root);
	late final TranslationsDialogsEn dialogs = TranslationsDialogsEn.internal(_root);
	late final TranslationsConfigModeChangeEn configModeChange = TranslationsConfigModeChangeEn.internal(_root);
	late final TranslationsAppRoutesEn app_routes = TranslationsAppRoutesEn.internal(_root);
	late final TranslationsLoadingIndicatorEn loading_indicator = TranslationsLoadingIndicatorEn.internal(_root);
	late final TranslationsVideoRemovalPromptEn video_removal_prompt = TranslationsVideoRemovalPromptEn.internal(_root);
	late final TranslationsLibraryLocationSetupDialogEn library_location_setup_dialog = TranslationsLibraryLocationSetupDialogEn.internal(_root);
	late final TranslationsHomePageEn home_page = TranslationsHomePageEn.internal(_root);
	late final TranslationsSongUnitEditorEn song_unit_editor = TranslationsSongUnitEditorEn.internal(_root);
}
...
class TranslationsLibraryEn {
	...
	late final TranslationsLibraryActionsEn actions = TranslationsLibraryActionsEn.internal(_root);
...
class TranslationsPlayerEn {
	...
	late final TranslationsPlayerDisplayModeEn displayMode = TranslationsPlayerDisplayModeEn.internal(_root);
	late final TranslationsPlayerAudioModeEn audioMode = TranslationsPlayerAudioModeEn.internal(_root);
	late final TranslationsPlayerPlaybackModeEn playbackMode = TranslationsPlayerPlaybackModeEn.internal(_root);
	late final TranslationsPlayerLyricsModeEn lyricsMode = TranslationsPlayerLyricsModeEn.internal(_root);
}

// Path: queue
class TranslationsQueueEn {
	TranslationsQueueEn.internal(this._root);
...
class TranslationsSongEditorEn {
	TranslationsSongEditorEn.internal(this._root);
...
class TranslationsLibraryLocationsEn {
	TranslationsLibraryLocationsEn.internal(this._root);
...
class TranslationsLocationSetupEn {
	TranslationsLocationSetupEn.internal(this._root);
...
class TranslationsConfigModeEn {
	TranslationsConfigModeEn.internal(this._root);
...
class TranslationsOnlineProvidersEn {
	TranslationsOnlineProvidersEn.internal(this._root);
...
class TranslationsLyricsEn {
	TranslationsLyricsEn.internal(this._root);
...
class TranslationsFloatingLyricsEn {
	TranslationsFloatingLyricsEn.internal(this._root);
...
class TranslationsSongPickerEn {
	TranslationsSongPickerEn.internal(this._root);
...
class TranslationsVideoRemovalEn {
	TranslationsVideoRemovalEn.internal(this._root);
...
class TranslationsDebugEn {
	TranslationsDebugEn.internal(this._root);
...
class TranslationsDialogsEn {
	...
	late final TranslationsDialogsHomeEn home = TranslationsDialogsHomeEn.internal(_root);
	late final TranslationsDialogsProgressDialogsEn progressDialogs = TranslationsDialogsProgressDialogsEn.internal(_root);
	late final TranslationsDialogsLibraryLocationsErrorEn libraryLocationsError = TranslationsDialogsLibraryLocationsErrorEn.internal(_root);
}

// Path: configModeChange
class TranslationsConfigModeChangeEn {
	TranslationsConfigModeChangeEn.internal(this._root);
...
class TranslationsAppRoutesEn {
	TranslationsAppRoutesEn.internal(this._root);
...
class TranslationsLoadingIndicatorEn {
	TranslationsLoadingIndicatorEn.internal(this._root);
...
class TranslationsVideoRemovalPromptEn {
	TranslationsVideoRemovalPromptEn.internal(this._root);
...
class TranslationsLibraryLocationSetupDialogEn {
	TranslationsLibraryLocationSetupDialogEn.internal(this._root);
...
class TranslationsSongUnitEditorEn {
	TranslationsSongUnitEditorEn.internal(this._root);
...
class TranslationsLibraryActionsEn {
	TranslationsLibraryActionsEn.internal(this._root);
...
class TranslationsPlayerDisplayModeEn {
	TranslationsPlayerDisplayModeEn.internal(this._root);
...
class TranslationsPlayerAudioModeEn {
	TranslationsPlayerAudioModeEn.internal(this._root);
...
class TranslationsPlayerPlaybackModeEn {
	TranslationsPlayerPlaybackModeEn.internal(this._root);
...
class TranslationsPlayerLyricsModeEn {
	TranslationsPlayerLyricsModeEn.internal(this._root);
...
class TranslationsDialogsHomeEn {
	TranslationsDialogsHomeEn.internal(this._root);
...
class TranslationsDialogsProgressDialogsEn {
	TranslationsDialogsProgressDialogsEn.internal(this._root);
...
class TranslationsDialogsLibraryLocationsErrorEn {
	TranslationsDialogsLibraryLocationsErrorEn.internal(this._root);
